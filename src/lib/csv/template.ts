...
export const CSV_COLUMNS: CsvColumnDef[] = [
  ...
  { key: 'images',       header: 'imagenes',           required: false, example: 'heladera-frente.jpg|heladera-interior.jpg', hint: 'Fotos del producto. Podés usar URLs HTTPS (https://...) o nombres de archivo local (heladera-frente.jpg). Para múltiples fotos, separá con | (pipe). Los archivos locales se suben a ML al publicar.' },
...
export async function downloadExcelTemplate() {
  ...
  const instrRows: string[][] = [
    ...
    ['3. Para imágenes, podés usar URLs HTTPS (https://foto.jpg) o nombres de archivo local (heladera-frente.jpg|heladera-lateral.jpg)'],
    ['   Los archivos locales se suben automáticamente a Mercado Libre al publicar. Separá múltiples fotos con |'],
